...
public class HttpResponse implements HttpServletResponse {
  ...
  /**
   * The error message set by <code>sendError()</code>. 200
   */
  ...
  protected void sendHeaders() throws IOException {
    ...
    synchronized (headers) {
      ...
      while (names.hasNext()) {
        ...
        ArrayList values = (ArrayList) headers.get(name);// 请求头的  内容  是一个 ArrayList 
...
/*  public static void main(String[] args) {
	  ArrayList values = new ArrayList();// 请求头的  内容  是一个 ArrayList 
	  values.add("1");
	  values.add("2");
	  values.add("3");
	  Iterator items = values.iterator();
